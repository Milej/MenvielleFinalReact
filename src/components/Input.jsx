...
const Input = ({ text, type, id, handleOnChange }) => {

  return (
    <div className="relative z-0 w-full mb-6 group">
      <input type={type} id={id} className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-zinc-700 peer" placeholder="" onChange={(e) => handleOnChange(e.target.value)}/>
